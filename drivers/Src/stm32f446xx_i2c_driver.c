...
//	}
	...
	printf("ITEVTEN_val : %lu\n", ITEVTEN_val);
	printf("ITBUFEN_val : %lu\n", ITBUFEN_val);
...
//	printf("SB temp : %lu\n", temp);
	...
	if (ITEVTEN_val && temp) {
		if (pI2CHandle->TxRxState == I2C_STATE_BUSY_IN_TX) {
			I2C_ExecuteAddressPhaseWrite(pI2CHandle->pI2Cx, pI2CHandle->DeviceAddr);
//			printf("I2C_ExecuteAddressPhaseWrite executed\n");
		}
		else if (pI2CHandle->TxRxState == I2C_STATE_BUSY_IN_RX) {
			I2C_ExecuteAddressPhaseRead(pI2CHandle->pI2Cx, pI2CHandle->DeviceAddr);
//			printf("I2C_ExecuteAddressPhaseRead executed\n");
		}
...
//	printf("ADDR temp : %lu\n", temp);
	if (ITEVTEN_val && temp) {
		...
		I2C_ClearADDRFlag(pI2CHandle);
//		printf("I2C_ClearADDRFlag executed\n");
	}
